...
export default function ConfirmAccountForm() {
    ...
    const sendHandler = async () => {
        ...
        await confirmSignUp(email, code)
            .then(() => {
                setFeedback("code confirmed successfully");
                resetForm();
    ...
    return (
        <>
            <fieldset style={{ margin: "12px 0", padding: 12 }}>
                ...
                <div style={{ fontStyle: "italic", color: "green", fontWeight: "bold" }}>Account created successfully, check your email for a verification code, and please type in your email and the code received.</div>
                <label
